...
@InitiatedBy(MoveStockIntiator.Initiator.class)
public class MoveStockResponder extends FlowLogic<SignedTransaction> {

    private final FlowSession counterpartySession;

    public MoveStockResponder(FlowSession counterpartySession) {
